...
public final class DaggerCoffeeApp_Coffee implements Coffee {
  ...
  private void initialize(final Builder builder) {  
    this.provideHeaterProvider = ScopedProvider.create(org.kp.digital.aem.personalization.poc.DripCofeeModule_ProvideHeaterFactory.create(builder.dripCofeeModule));
    this.thermosepianPumpProvider = org.kp.digital.aem.personalization.poc.ThermosepianPump_Factory.create(provideHeaterProvider);
    this.providePumpProvider = org.kp.digital.aem.personalization.poc.PumpModule_ProvidePumpFactory.create(builder.pumpModule, thermosepianPumpProvider);
    this.coffeeMakerProvider = org.kp.digital.aem.personalization.poc.CoffeeMaker_Factory.create(provideHeaterProvider, providePumpProvider);
  }
